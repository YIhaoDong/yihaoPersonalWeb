<script lang="ts">
	...
	const contactInfo = [
		{
			...
			label: 'Email',
			value: 'yihao.dong@outlook.com',
			href: 'mailto:yihao.dong@outlook.com'
		},
		{
	...
	const academicProfiles = [
		{ name: 'Google Scholar', href: '#', available: false },
		{ name: 'ResearchGate', href: '#', available: false },
		{ name: 'LinkedIn', href: '#', available: false },
		{ name: 'GitHub', href: '#', available: false },
		{ name: 'ORCID', href: '#', available: false }
	];
</script>
