...
ADR;TYPE=WORK:;;University of Sydney;Sydney;NSW;2000;Australia
...
END:VCARD`;
	...
	function shareContact() {
		...
		const file = new File([blob], 'Yihao_Dong.vcf', { type: 'text/vcard' });

		if (navigator.share && navigator.canShare({ files: [file] })) {
			navigator.share({
				title: 'Yihao Dong - Contact',
				text: 'Add Yihao Dong to your contacts',
				files: [file]
			}).catch((error) => {
...
<svelte:head>
	<title>Add Contact - Yihao Dong</title>
...
<section class="bg-gradient-to-br from-blue-50 to-white py-16">
	<div class="section-container">
		...
		<p class="text-xl text-gray-600 text-center max-w-3xl mx-auto">
			Save my contact information directly to your device
		</p>
	</div>
</section>
	...
	<div class="max-w-2xl mx-auto">
		...
		<div class="bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-100">
			...
			<div class="bg-gradient-to-br from-blue-600 to-blue-700 px-8 py-12 text-center">
				...
				<h2 class="text-3xl font-bold text-white mb-2">Yihao Dong</h2>
			...
			<div class="px-8 py-8 space-y-6">
				...
				<div class="flex items-start space-x-4">
					...
					<div>
						...
						<p class="text-gray-900">Sydney, NSW 2000</p>
			...
			<div class="px-8 pb-8 space-y-3">
				...
				<button
					...
					class="w-full bg-gray-100 text-gray-700 px-6 py-3 rounded-lg hover:bg-gray-200 transition-colors font-medium flex items-center justify-center space-x-2"
				>
				...
				<a
					href="/contact"
					class="block w-full text-center text-gray-600 px-6 py-3 rounded-lg hover:bg-gray-50 transition-colors font-medium"
				>
		...
		<div class="mt-8 bg-blue-50 rounded-lg p-6">
			...
			<ul class="space-y-2 text-gray-700">
				<li class="flex items-start">
					...
					<span>Click "Add to Contacts" button above</span>
				</li>
				<li class="flex items-start">
					<span class="font-bold mr-2">2.</span>
					<span>A vCard file (Yihao_Dong.vcf) will be downloaded or shared</span>
				</li>
				<li class="flex items-start">
